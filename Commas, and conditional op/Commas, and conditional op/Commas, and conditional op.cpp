...
//With Conditional Operator
	...
	example = (a < b) ? high_number : low_number; // loks like if/else statement: if (a<b), example = high number; else, example = low number
	std::cout << "example is\n" << example << '\n';
	newlines

//always put conditional part in ()

//Because conditional operator is an expression, it can be used where if/else can't
